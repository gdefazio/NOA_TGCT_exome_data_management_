...
<<<<<<< HEAD
    ...
    Carriers['gnomAD_exomes_AF'].replace('.', np.NaN, inplace=True)
    Carriers['gnomAD_exomes_AFR_AF'].replace('.', np.NaN, inplace=True)
    Carriers['gnomAD_exomes_AMR_AF'].replace('.', np.NaN, inplace=True)
    Carriers['gnomAD_exomes_ASJ_AF'].replace('.', np.NaN, inplace=True)
    Carriers['gnomAD_exomes_EAS_AF'].replace('.', np.NaN, inplace=True)
    Carriers['gnomAD_exomes_FIN_AF'].replace('.', np.NaN, inplace=True)
    Carriers['gnomAD_exomes_NFE_AF'].replace('.', np.NaN, inplace=True)
